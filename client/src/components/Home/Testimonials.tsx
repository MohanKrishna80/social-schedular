        ...
        <section className="py-24 bg-slate-50 dark:bg-slate-900">
            <div className="max-w-6xl mx-auto px-4 sm:px-6">
                <div className="text-center mb-14">
                    ...
                    <p className="mt-5 text-gray-500 max-w-md mx-auto dark:text-slate-400">Join thousands of people who automate their social media with Scheduler.</p>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                    {testimonials.map((t, i) => (
                        <div key={i} className="bg-white rounded-2xl border border-slate-100 hover:border-slate-200 hover:shadow-lg hover:shadow-slate-100 p-6 transition-all flex flex-col gap-4 dark:bg-slate-950 dark:border-slate-800 dark:hover:border-slate-700 dark:hover:shadow-none">
                            <p className="text-slate-600 text-sm leading-relaxed flex-1 dark:text-slate-300">"{t.text}"</p>
